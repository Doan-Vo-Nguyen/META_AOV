...
(1, 1, 1, '++', 1, 54.8, 34, 1.43),
(2, 2, 1, '+', 1, 53.2, 30, 1.23),
(3, 9, 2, '++', 1, 52.4, 31, 1.38);
...
--
ALTER TABLE `items`
  MODIFY `id_items` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=89;
...
--
ALTER TABLE `spells`
  MODIFY `id_spell` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `stats_spell`
  ADD CONSTRAINT `stats_spell_ibfk_1` FOREIGN KEY (`id_champ`) REFERENCES `champions` (`id_champ`),
  ADD CONSTRAINT `stats_spell_ibfk_2` FOREIGN KEY (`id_spell`) REFERENCES `spells` (`id_spell`);
