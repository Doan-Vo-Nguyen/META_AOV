                                ...
                                <div style="position:relative">
                                    <div id="splash-content" class="spct-st">
                                            ...
                                            <div class="text">
                                                <div style="display: flex;">
                                                    ...
                                                    <div class="image-inner"
                                                        ...
                                                        $sql = "SELECT * from champions JOIN stats_champions ON champions.ID = stats_champions.id_champ JOIN lane ON lane.id = stats_champions.id_lane JOIN role_champions ON role_champions.id_role = champions.id_role WHERE champions.ID = 1 AND lane.id = 2 AND role_champions.id_role = 1";
                                        ...
                                        <div class="descript descript-bg descript-pos">
                                            ...
                                            $sql = "SELECT * FROM champions JOIN stats_champions ON champions.ID = stats_champions.id_champ JOIN lane WHERE champions.id_lane = lane.id AND stats_champions.id_lane = 2";
                                            $result = mysqli_query($conn, $sql);
                            ...
                            <div class="bct-paragraph bct-bg">
                                ...
                                <div class="bct-p bct-bg">
                                    <div
                                        ...
                                        <?php
                                                                $sql = "SELECT * FROM champions JOIN stats_start_items ON champions.ID = stats_start_items.id_champ JOIN items WHERE stats_start_items.id_items = items.id AND stats_start_items.id_lane = 2 AND champions.ID = $GLOBALS[id]";
                                                                $result = mysqli_query($conn, $sql);
                                                                $count = mysqli_num_rows($result);
                                                                $row = mysqli_fetch_assoc($result);
                                                                if ($count > 0) {
                                                            ...
                                                            <div style="margin-top:1px">
                                                                <div class="items items-bg">
                                                                    ...
                                                                    for ($i = 0; $i < count($row_array); $i++) {
                                                                        ...
                                                                        AND stats_start_items.id_lane = 2 AND champions.ID = $GLOBALS[id] AND stats_start_items.id_items = $row_array[$i]";
                                                                        $result = mysqli_query($conn, $sql);
                                                                        $row = mysqli_fetch_assoc($result);
                                                                        if ($i <= count($row_array)) {
                            ...
                            <div id="10-1-tab" class="tab-selected badge b-hover" style="cursor:pointer"
                                ...
                                <div class="rating" style="width:100%">
                                    <div class="rating-inner text-hover" style="text-align:center">
                                        <span class="win">56%</span>
                                    </div>
                                    <div class="rating-inner text-hover" style="text-align:center">
                                        <span class="pick">52%</span>
                                    </div>
                                </div>
                            </div>
