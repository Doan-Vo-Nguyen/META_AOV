                                ...
                                <div style="position:relative">
                                    <div id="splash-content" class="spct-st">
                                            ...
                                            <div class="text">
                                                <div style="display: flex;">
                                                    ...
                                                    <div class="image-inner"
                                                        ...
                                                        $sql = "SELECT * from champions JOIN stats_champions ON champions.ID = stats_champions.id_champ JOIN lane ON lane.id = stats_champions.id_lane JOIN role_champions ON role_champions.id_role = champions.id_role WHERE champions.ID = 1 AND lane.id = 1 AND role_champions.id_role = 1";
                                        ...
                                        <div class="descript descript-bg descript-pos">
                                            <?php
                                            require '../../5v5/connect.php';
                                            $sql = "SELECT * FROM champions JOIN stats_champions ON champions.ID = stats_champions.id_Champ JOIN lane WHERE champions.id_lane = lane.id AND stats_champions.id_lane = 1";
                                            $result = mysqli_query($conn, $sql);
