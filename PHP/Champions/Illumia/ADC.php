...
<body class="wrapper-page" style="background-position-y: 0px !important;">
                ...
                <div id="content-wrapper" class="wr-tt ge-ct">
                                ...
                                <div style="position:relative">
                                    <div id="splash-content" class="spct-st">
                                            ...
                                            <div class="text">
                                                <div style="display: flex;">
                                                    ...
                                                    <div class="image-inner"
                                                        ...
                                                        $sql = "SELECT * from champions JOIN stats_champions ON champions.ID = stats_champions.id_champ JOIN lane ON lane.id = stats_champions.id_lane JOIN role_champions ON role_champions.id_role = champions.id_role WHERE champions.champ_Name = $name AND lane.id = 3 AND role_champions.id_role = 1";
                                        ...
                                        <div class="map-mode ch-ct">
                                            ...
                                            <a href="../Illumia/3v3.php" class="3v3-page ge-st"
                                                style="border-bottom-color: #fff;">
                                                <span class="name-map text-hover">3v3</span>
                                            </a>
                                            <a href="../Illumia/1v1.php" class="1v1-page ge-st"
                                                style="border-bottom-color: #fff;">
                                        ...
                                        <div class="descript descript-bg descript-pos">
                                            <?php
                                            require '../../5v5/connect.php';
                                            $sql = "SELECT * FROM champions JOIN stats_champions ON champions.ID = stats_champions.id_champ JOIN lane WHERE champions.id_lane = lane.id AND stats_champions.id_lane = 3";
                                            $result = mysqli_query($conn, $sql);
                                            ...
                                            <div class="descript-para" style="display: flex;">
                                                <span>
                                                    <?php
                                                    $sql = "SELECT * FROM champions WHERE ID = $GLOBALS[id]";
                                                    $result = mysqli_query($conn, $sql);
                                                    $count = mysqli_num_rows($result);
                                                    $row = mysqli_fetch_assoc($result);
                                                    $name = $row['champ_Name'];
                                    ...
                                    <div style="display: flex;justify-content: center;" class="ch-ct">
                                        <div class="h-content content-details">
                                            ...
                                            <div class="lane-content ch-ct">
                                                ...
                                                <a href="#" class="active text-ac ge-st"
                                                    style="border-bottom-color: #fff;">
                                                    <span>
                                                    ...
                                                    <div class="bct-paragraph bct-bg">
                                                        ...
                                                        <div class="bct-p">
                                                            <div
                                                                ...
                                                                <?php
                                                                require '../../5v5/connect.php';
                                                                $sql = "SELECT * FROM champions JOIN stats_spell ON champions.ID = stats_spell.id_Champ JOIN spells WHERE stats_spell.id_spell = spells.id AND champions.ID = $GLOBALS[id]";
                                                                $result = mysqli_query($conn, $sql);
                                                                $count = mysqli_num_rows($result);
                                                                $row = mysqli_fetch_assoc($result);
                                                                if ($count > 0) {
                                                                        ...
                                                                        <div style="margin-top:1px">
                                                                            ...
                                                                            <div style="display: flex;">';
                                                                                ...
                                                                                for ($i = 0; $i < count($row_array); $i++) {
                                                                                    $sql = "SELECT * FROM champions JOIN stats_spell ON champions.ID = stats_spell.id_Champ JOIN spells WHERE stats_spell.id_spell = spells.id AND champions.ID = $GLOBALS[id] AND stats_spell.id_spell = $row_array[$i]";
                                                                                    $result = mysqli_query($conn, $sql);
                                                                                    $row = mysqli_fetch_assoc($result);
                                        ...
                                        <div class="bct-paragraph bct-bg">
                                            ...
                                            <div class="bct-p bct-bg">
                                                <div
                                                    ...
                                                    <?php
                                                                $sql = "SELECT * FROM champions JOIN stats_start_items ON champions.ID = stats_start_items.id_champ JOIN items WHERE stats_start_items.id_items = items.id AND stats_start_items.id_lane = 3 AND champions.ID = $GLOBALS[id]";
                                                                $result = mysqli_query($conn, $sql);
                                                                $count = mysqli_num_rows($result);
                                                                $row = mysqli_fetch_assoc($result);
                                                                if ($count > 0) {
                                                            ...
                                                            <div style="margin-top:1px">
                                                                <div class="items items-bg">
                                                                    ...
                                                                    for ($i = 0; $i < count($row_array); $i++) {
                                                                        ...
                                                                        AND stats_start_items.id_lane = 3 AND champions.ID = $GLOBALS[id] AND stats_start_items.id_items = $row_array[$i]";
                                                                        $result = mysqli_query($conn, $sql);
                                                                        $row = mysqli_fetch_assoc($result);
                                                                        if ($i <= count($row_array)) {
                    ...
                    <div class="bct-inner te-st">
                        <div class="bct-bg counter-content">
                            ...
                            <div style="padding-top: 10px;" class="counters-grid">
                                <?php
                                        $sql = "SELECT * FROM champions JOIN stats ON champions.ID = stats.id_Champ JOIN lane WHERE stats.id_lane = lane.id AND stats.id_lane = 3 EXCEPT SELECT * FROM champions JOIN stats ON champions.ID = stats.id_Champ JOIN lane WHERE stats.id_Champ = 1 AND stats.id_lane = 3";
                                        $result = mysqli_query($conn, $sql);
                                        $row = mysqli_num_rows($result);
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                $sql_oneChamp = "SELECT * FROM champions JOIN stats ON champions.ID = stats.id_Champ JOIN lane WHERE lane.id = stats.id_lane AND stats.id_Champ = 1 AND stats.id_lane = 3";
                    ...
                    <div class="bct-inner te-st">
                        <div class="bct-bg counter-content">
                            ...
                            <div style="padding-top: 10px;" class="counters-grid">
                                <?php
                                        $sql = "SELECT * FROM champions JOIN stats ON champions.ID = stats.id_Champ JOIN lane WHERE stats.id_lane = lane.id AND stats.id_lane = 3 EXCEPT SELECT * FROM champions JOIN stats ON champions.ID = stats.id_Champ JOIN lane WHERE stats.id_Champ = 9 AND stats.id_lane = 3";
                                        $result = mysqli_query($conn, $sql);
                                        $row = mysqli_num_rows($result);
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                $sql_oneChamp = "SELECT * FROM champions JOIN stats ON champions.ID = stats.id_Champ JOIN lane WHERE lane.id = stats.id_lane AND stats.id_Champ = 9 AND stats.id_lane = 3";
                                                $result_oneChamp = mysqli_query($conn, $sql_oneChamp);
                                                $row_one = mysqli_fetch_assoc($result_oneChamp);
                                                $champ_name = $row['champ_Name'];
                                                $champ_id = $row['ID'];
    ...
    <?php
        include '../../User/Check_Session.php'
    ?>
</body>
