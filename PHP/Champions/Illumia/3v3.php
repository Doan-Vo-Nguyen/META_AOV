                                ...
                                <div style="position:relative">
                                    <div id="splash-content" class="spct-st">
                                        ...
                                        <div class="descript descript-bg descript-pos">
                                            <?php
                                            require '../../5v5/connect.php';
                                            $sql = "SELECT * FROM champions JOIN stats_champions ON champions.ID = stats_champions.id_Champ JOIN lane WHERE champions.id_lane = lane.id AND champions.ID = 1";
                                            $result = mysqli_query($conn, $sql);
