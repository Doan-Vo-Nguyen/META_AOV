                                                                        ...
                                                                        <div style="margin-top:1px">
                                                                            ...
                                                                            <div style="display: flex;">';
                                                                                ...
                                                                                for ($i = 0; $i < count($row_array); $i++) {
                                                                                    $sql = "SELECT * FROM champions JOIN stats_spell ON champions.ID = stats_spell.id_Champ JOIN spells ON stats_spell.id_spell = spells.id JOIN lane WHERE stats_spell.id_lane = lane.id AND champions.ID = $GLOBALS[id] AND lane.id = $GLOBALS[id_lane] AND stats_spell.id_spell = $row_array[$i]";
                                                                                    $result = mysqli_query($conn, $sql);
                                                                                    $row = mysqli_fetch_assoc($result);
                                ...
                                <div id="active-runes" class="bct-p bct-bg">
                                    ...
                                    <div style="margin-top: -10px;width:100%;display:flex;justify-content:center;">
                                        ...
                                        <div id="10-1-tab" class="tab-selected badge b-hover" style="cursor:pointer"
                                            ...
                                            <div class="rating" style="width:100%">
                                                <div class="rating-inner text-hover" style="text-align:center">
                                                    <span class="win">56.3%</span>
                                                </div>
                                                <div class="rating-inner text-hover" style="text-align:center">
                                                    <span class="pick">67.2%</span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div id="10-19-tab" class="badge b-hover" style="cursor:pointer"
                                            ...
                                            <div class="rating" style="width:100%">
                                                <div class="rating-inner text-hover" style="text-align:center">
                                                    <span class="win">42%</span>
                                                </div>
                                                <div class="rating-inner text-hover" style="text-align:center">
                                                    <span class="pick">41%</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="bct-text bct-bg">
                            ...
                            <div class="bct-p">
                                ...
                                <?php
                                   ...
                                   $itemNum = "17,2,49,1,1,22,1,11,65,2,2,23,4,5,66,1,19,1,19,67,1,2,5,20,5,9,68,1,19,12,69";
                                   $row_array = explode(',', $itemNum);
                                   for ($i = 0; $i < count($row_array); $i++) {
